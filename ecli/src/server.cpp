...
std::vector<std::tuple<int, std::string>> server_manager::list_all_trackers(void)
{
  return core_tracker_manager.get_tracker_list();
}

void server_manager::stop_tracker(std::size_t tracker_id)
{
...
std::size_t server_manager::start_trackers(void)
{
...
void server_manager::check_auto_exit(std::size_t checker_count)
{
...
int server_manager::start_eunomia(void)
{
