...
static void from_json(const nlohmann::json& j,
                      export_types_struct_member_meta& data) {
...
static void from_json(const nlohmann::json& j, map_sample_meta& data) {
...
static void from_json(const nlohmann::json& j,
                      data_section_variable_meta& data) {
    get_from_json_at(name);
    get_from_json_at(type);
...
static void from_json(const nlohmann::json& j, bpf_skel_doc& data) {
...
int bpf_skeleton::open_from_json_config(const std::string& json_str,
...
int bpf_skeleton::open_from_json_config(const std::string& json_package,
                                        char* btf_archive_path) noexcept {
    std::vector<char> bpf_object_buffer;
    std::string json_str;
    try {
